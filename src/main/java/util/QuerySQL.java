...
public class QuerySQL {
    ...
    public static final String COUNT_USUARIO_POR_EMAIL = "SELECT COUNT(*) FROM Usuario WHERE email = ?";

    public static final String COUNT_USUARIO_POR_EMAIL_SENHA = "SELECT COUNT(*) FROM Usuario WHERE email = ? AND senha = ?";
